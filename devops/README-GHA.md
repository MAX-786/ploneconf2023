...
2. Go to your repository at [MAX-786/ploneconf2023](https://github.com/MAX-786/ploneconf2023).
...
- [Backend Tests Workflow](https://github.com/MAX-786/ploneconf2023/actions/workflows/backend.yml)
- [Frontend Tests Workflow](https://github.com/MAX-786/ploneconf2023/actions/workflows/frontend.yml)

Upon successful completion of the tests, Docker images for the Backend (`ghcr.io/MAX-786/ploneconf2023-backend`) and Frontend (`ghcr.io/MAX-786/ploneconf2023-frontend`) will be available.

### Initiating Manual Deployment

1. Navigate to [Manual Deployment of ploneconf2023.example.com](https://github.com/MAX-786/ploneconf2023/actions/workflows/manual-deploy.yml).
